...
- **OPENSEX STANDALONE**: Visit the OpenSex Standalone Nexus page [here](https://www.nexusmods.com/skyrimspecialedition/mods/61167) and download the latest release via Mod Manager Download (OpenSex version 1.5 as of writing) and the Optional File "SOS or SAM or HIMBO light 1.15 genital size". <br>Install and merge both in MO2 as "[NoDelete] (OTC01c) OpenSex Standalone" and enable.
